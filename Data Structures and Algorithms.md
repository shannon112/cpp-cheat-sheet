...
- [C++ Data Structures and Algorithms Cheat Sheet](#c-data-structures-and-algorithms-cheat-sheet)
	...
	- [1.0 Data Structures](#10-data-structures)
		...
		- [1.14 Unordered Set `std::set`](#114-unorderedset-stdunorderedset)
		- [1.15 Unordered Multiset `std::multiset`](#115-unorderedmultiset-stdunorderedmultiset)
		- [1.16 Unordered Map `std::map`](#116-unorderedmap-stdunorderedmap)
		- [1.17 Unordered Multimap `std::multimap`](#117-unorderedmultimap-stdunorderedmultimap)
	- [2.0 Trees](#20-trees)
